...
import { MIGRATION_0004_PODCAST_FEED_METADATA } from './0004_podcast_feed_metadata';
...
export const MIGRATIONS: readonly Migration[] = [
  ...
  { version: 4, name: '0004_podcast_feed_metadata', sql: MIGRATION_0004_PODCAST_FEED_METADATA },
];
