...
export const en: Messages = {
  ...
  a11y: {
    ...
    movedTo: (label: string, position: number, total: number) =>
      `Moved ${label} to ${position} of ${total}`,
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
  ...
  seed: {
    ...
    addTakeOp: (take: string) => `Add ${take}`,
...
Tag #PodsNow to share your thoughts`,
  ...
  home: {
    ...
    reimportShow: 'Load show details again',
    onboardingTitle: 'Set up your show',
    onboardingBody:
      'If your show is already out, find it by name and import its details and past episodes',
    onboardingImport: 'Import an existing show',
    onboardingNew: 'Start a new show',
  },
  ...
  podcastImport: {
    ...
    search: 'Search',
    searching: 'Searching…',
    noResults: 'Nothing found. Try another name, or import from the RSS URL',
    resultsHeader: 'Results',
    noFeed: 'No public RSS URL',
    urlHeader: 'Import from an RSS URL',
    urlLabel: 'RSS URL',
    urlHelp: 'You can find it in your hosting service’s show settings',
    loadUrl: 'Load',
    reloadHeader: 'Your show',
    ...
    nextNumber: (n: number) => `New episodes start at #${n}`,
    noEpisodeNumbers:
      'The RSS has no episode numbers. You can change the number of a new episode after creating it',
    overwriteNote:
    ...
    coverFailed: 'The artwork could not be saved. You can set it later in Show settings',
    toHome: 'Go to Home',
    toShow: 'Open Show settings',
  ...
  record: {
    ...
    takeInserted: (duration: string, at: string) => `Recording inserted at ${at} (${duration})`,
    ...
    confirmDeleteTopic: (heading: string) => `Delete “${heading}”?`,
    confirmDeleteTopicNote: 'Its script will be deleted too.',
    addTopics: 'Add talking points',
    finish: 'Finish take',
    start: 'Start recording',
    startHere: 'Record here',
  ...
  edit: {
    ...
    confirmDelete: (duration: string) => `Delete the selected ${duration}?`,
    ...
    confirmRemoveOverlay: 'Remove this sound?',
    removeOverlayShort: 'Remove',
  ...
  showSettings: {
    ...
    topicCount: (n: number) => `${n} ${n === 1 ? 'item' : 'items'}`,
    a11yEditTopicTemplate: 'Edit the talking point template',
    a11ySaveTopicTemplate: 'Save the talking point template',
    topicTemplateSaved: 'Saved the talking point template',
    duckingLabel: 'BGM ducking',
    a11yDuckAmount: 'ducking amount',
    chooseAsset: 'Choose from sounds',
    ...
    a11yEditDescriptionTemplate: 'Edit the description template',
    a11ySaveDescriptionTemplate: 'Save the description template',
    descriptionTemplateSaved: 'Saved the description template',
    placeholders: {
      title: 'title',
  ...
  showAssets: {
    title: 'Sounds',
    add: 'Add a sound',
    count: (n: number) => `${n} sound${n === 1 ? '' : 's'}`,
    a11yOpen: (n: number) => `Open sound management, ${n} sound${n === 1 ? '' : 's'}`,
    ...
    confirmRemove: (name: string) => `Delete the asset “${name}”?`,
    preview: 'Preview',
    stop: 'Stop',
