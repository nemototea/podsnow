...
FIXED = {
    'dark': {
        ...
        # 編集タブの録音機の表現（PN-01、#115）。ほかの画面では使わない。
        'well': (0.1500, 0.0060, 237.0),
        'key': (0.3300, 0.0110, 237.0),
        'keyHi': (0.4000, 0.0120, 237.0),
        'keySide': (0.1400, 0.0050, 237.0),
        'keyShadow': (0.1000, 0.0040, 237.0),
        'seamDark': (0.1200, 0.0050, 237.0),
        'seamLight': (0.2800, 0.0110, 237.0),
    },
    'light': {
        ...
        # 編集タブの録音機の表現（PN-01、#115）。ほかの画面では使わない。
        'well': (0.9250, 0.0040, 95.0),
        'key': (1.0000, 0.0000, 89.9),
        'keyHi': (1.0000, 0.0000, 89.9),
        'keySide': (0.8400, 0.0060, 236.0),
        'keyShadow': (0.7600, 0.0100, 236.0),
        'seamDark': (0.8400, 0.0040, 95.0),
        'seamLight': (1.0000, 0.0000, 89.9),
    },
}
...
# 表示窓（編集タブの黒いガラス）。テーマに関係なく暗い。中の色はダークの意味の色をそのまま使う。
...
def build(theme: str) -> dict[str, str]:
    ...
    # 編集タブのキーの側面（押し込みの厚み）。塗りのキーは塗りを暗くした色。
