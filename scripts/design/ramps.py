...
FIXED = {
    'dark': {
        # PN-01（#115）: 面はグラファイトの切削パネル。表示窓（disp*）だけが黒い。
        'bg': (0.3024, 0.0078, 240.1),
        'surface': (0.3371, 0.0086, 233.9),
        'surfaceRaised': (0.3721, 0.0096, 241.9),
        'surfaceHover': (0.4125, 0.0103, 236.8),
        'border': (0.4520, 0.0110, 232.6),
        'well': (0.2459, 0.0072, 248.1),
        'key': (0.3721, 0.0096, 241.9),
        'keyHi': (0.4273, 0.0102, 236.8),
        'keySide': (0.2121, 0.0050, 248.1),
        'keyShadow': (0.1712, 0.0039, 229.1),
        'seamDark': (0.2067, 0.0061, 236.9),
        'seamLight': (0.3641, 0.0085, 233.9),
        ...
        'voiceFill': (0.2400, 0.0200, 233.7),
        'voiceFillAlt': (0.2700, 0.0215, 235.1),
        'voiceSubtle': (0.3020, 0.0197, 236.2),
        'musicSolid': (0.7935, 0.1028, 288.8),
        'musicFill': (0.2400, 0.0471, 292.2),
        'musicFillAlt': (0.2700, 0.0539, 293.8),
        'musicSubtle': (0.2928, 0.0344, 291.4),
        'insertSolid': (0.8231, 0.0880, 230.9),
        'insertFill': (0.2400, 0.0393, 234.0),
        'insertFillAlt': (0.2700, 0.0429, 231.8),
        'insertSubtle': (0.3003, 0.0270, 238.0),
        'mistakeSolid': (0.8415, 0.0944, 68.5),
        'mistakeFill': (0.2400, 0.0317, 72.3),
        'mistakeFillAlt': (0.2700, 0.0380, 72.7),
        'mistakeSubtle': (0.3051, 0.0226, 66.8),
        'successSolid': (0.8236, 0.0901, 162.5),
        'successSubtle': (0.3155, 0.0316, 169.4),
    },
    'light': {
        # PN-01（#115）: 面は梨地のアルミ（シルバー）。キーは面より明るい。
        'bg': (0.8927, 0.0043, 236.5),
        'surface': (0.9629, 0.0025, 228.8),
        'surfaceRaised': (0.9262, 0.0042, 236.5),
        'surfaceHover': (0.8585, 0.0060, 239.8),
        'border': (0.7822, 0.0088, 236.6),
        'well': (0.8298, 0.0069, 233.7),
        'key': (0.9629, 0.0025, 228.8),
        'keyHi': (1.0000, 0.0000, 89.9),
        'keySide': (0.7715, 0.0115, 234.9),
        'keyShadow': (0.7077, 0.0127, 240.0),
        'seamDark': (0.7822, 0.0088, 236.6),
        'seamLight': (0.9539, 0.0025, 228.8),
        'textPrimary': (0.2374, 0.0073, 248.1),
        'accentSolid': (0.9177, 0.1645, 119.1),
        'accentSolidPressed': (0.8259, 0.1592, 119.1),
        'accentOnSolid': (0.2277, 0.0448, 126.2),
        ...
        'voiceFill': (0.8800, 0.0111, 226.0),
        'voiceFillAlt': (0.8450, 0.0157, 222.7),
        'voiceSubtle': (0.9451, 0.0070, 219.6),
        'musicSolid': (0.4965, 0.1131, 295.4),
        'musicFill': (0.8800, 0.0237, 301.9),
        'musicFillAlt': (0.8450, 0.0366, 301.4),
        'musicSubtle': (0.9474, 0.0168, 304.8),
        'insertSolid': (0.5086, 0.0969, 237.2),
        'insertFill': (0.8800, 0.0193, 230.7),
        'insertFillAlt': (0.8450, 0.0229, 233.4),
        'insertSubtle': (0.9524, 0.0134, 233.7),
        'mistakeSolid': (0.4865, 0.0943, 68.1),
        'mistakeFill': (0.8800, 0.0313, 75.2),
        'mistakeFillAlt': (0.8450, 0.0390, 80.0),
...
TEXT_SURFACES = ('bg', 'surface', 'surfaceRaised', 'surfaceHover', 'well')

SOLVED = {
    'dark': {
        'textSecondary': (0.0114, 226.0, 5.6),
        'textTertiary': (0.0151, 231.3, 4.6),
        'textDisabled': (0.0164, 229.1, 3.1),
        'borderStrong': (0.0166, 229.1, 3.1),
        'dangerText': (0.1018, 2.4, 5.0),
        'dangerBorder': (0.1087, 1.3, 3.2),
        'recText': (0.1060, 37.9, 5.0),
        'musicText': (0.0775, 289.6, 5.0),
        'musicBorder': (0.0866, 290.9, 3.2),
        'insertText': (0.0670, 234.3, 5.0),
        'insertBorder': (0.0720, 230.3, 3.2),
        'mistakeText': (0.0761, 66.6, 5.0),
        'mistakeBorder': (0.0844, 70.7, 3.2),
        'voiceBorder': (0.0291, 232.8, 3.2),
        'successText': (0.0701, 163.3, 5.0),
        'keyEdge': (0.0100, 236.0, 3.0),
    },
    'light': {
...
# 表示窓（PN-01 の黒いガラス）。テーマに関係なく暗い。中の色はダークの意味の色をそのまま使う。
DISPLAY_BG = (0.1613, 0.0065, 237.0)
DISPLAY_LINE = (0.2799, 0.0123, 232.9)


def display() -> dict[str, str]:
    dark = {name: _hex(lch) for name, lch in FIXED['dark'].items()}
    bg = _hex(DISPLAY_BG)
    d = {
        'dispBg': bg,
        'dispLine': _hex(DISPLAY_LINE),
        'dispInk': dark['textPrimary'],
        'dispDim': _solve(0.0120, 232.0, 4.6, [bg, _hex(DISPLAY_LINE)], True),
        'dispVoice': dark['voiceSolid'],
        'dispMusic': dark['musicSolid'],
        'dispInsert': dark['insertSolid'],
        'dispMistake': dark['mistakeSolid'],
        'dispSuccess': dark['successSolid'],
        'dispRec': dark['recSolid'],
        'dispRecSubtle': dark['recSubtle'],
    }
    d['dispRecText'] = _solve(0.1060, 37.9, 6.0, [bg, d['dispRecSubtle']], True)
    return d
...
def build(theme: str) -> dict[str, str]:
    ...
    # キーの側面（押し込みの厚み）。塗りのキーは塗りを暗くした色。
    t['keySideAccent'] = _hex((0.7200, 0.1450, 119.1))
    t['keySideRec'] = _hex((FIXED[theme]['recSolid'][0] - 0.1400, 0.1300, 35.7))
    t.update(display())
